...
{
    [TestFixture]
    public class AdjacentLayoutNoPaddingSpacing
    {
        [Test]
        public void OneChild()
        {
            ...
            var layout = new AdjacentLayout { Orientation = OrientationOptions.Horizontal, Spacing = 5 };
        ...
        public void TwoChildren()
        {
            ...
            Assert.That(child.X, Is.EqualTo(0));
            Assert.That(child.Y, Is.EqualTo(0));
            Assert.That(child2.X, Is.EqualTo(55));
