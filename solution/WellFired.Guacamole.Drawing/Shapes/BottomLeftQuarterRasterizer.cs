...
{
    public class BottomLeftQuarterRasterizer : IRasterizableShape
    {
        ...
        public BottomLeftQuarterRasterizer(Vector center, double radius, double thickness)
        {
            _centerX = center.X;
            _centerY = center.Y;
            _radius = radius;
        ...
        {
            var innerCircle = new BottomLeftQuarterRasterizer(new Vector(_centerX, _centerY), _radius - _thickness, _thickness);
