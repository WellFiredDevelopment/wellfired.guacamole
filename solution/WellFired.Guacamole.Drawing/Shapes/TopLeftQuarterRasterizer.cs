...
{
    public class TopLeftQuarterRasterizer : IRasterizableShape
    {
        ...
        public TopLeftQuarterRasterizer(Vector center, double radius, double thickness)
        {
            _centerX = center.X;
            _centerY = center.Y;
            _radius = radius;
        ...
        {
            var innerCircle = new TopLeftQuarterRasterizer(new Vector(_centerX, _centerY), _radius - _thickness, _thickness);
