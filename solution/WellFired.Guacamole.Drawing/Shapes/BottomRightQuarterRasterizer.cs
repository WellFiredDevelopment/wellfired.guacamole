...
{
    public class BottomRightQuarterRasterizer : IRasterizableShape
    {
        ...
        public BottomRightQuarterRasterizer(Vector center, double radius, double thickness)
        {
            _centerX = center.X;
            _centerY = center.Y;
            _radius = radius;
        ...
        {
            var innerCircle = new BottomRightQuarterRasterizer(new Vector(_centerX, _centerY), _radius - _thickness, _thickness);
