...
{
	internal static class SliderView
	{
		public static readonly Style Style = new Style
		{
			Setters =
			{
				...
				new Setter {Property = Views.SliderView.ThumbBackgroundColorProperty, Value = UIColor.FromRGB(64, 124, 191)},
				new Setter {Property = Views.SliderView.ThumbOutlineColorProperty, Value = UIColor.FromRGB(0, 0, 0)},
				new Setter {Property = Views.SliderView.ThumbCornerRadiusProperty, Value = 0.0}
			},
			Triggers =
			{
				new Trigger
				{
					...
					{
						new Setter {Property = View.BackgroundColorProperty, Value = UIColor.FromRGB(125, 125, 125)},
						new Setter {Property = Views.SliderView.ThumbBackgroundColorProperty, Value = UIColor.FromRGB(125, 125, 125)}
					}
				},
				new Trigger
				{
					...
					Setters =
					{
						...
						new Setter {Property = Views.SliderView.ThumbBackgroundColorProperty, Value = UIColor.FromRGB(158, 158, 158)}
					}
				},
				new Trigger
				{
				...
				new Trigger
				{
					...
					Setters =
					{
						...
						new Setter {Property = Views.SliderView.ThumbBackgroundColorProperty, Value = UIColor.FromRGB(100, 100, 100)}
					}
				}
			}
		};
